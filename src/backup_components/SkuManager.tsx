                            ...
                            <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                                <thead className="bg-gray-50 dark:bg-gray-800">
                                    <tr>
                                        ...
                                        <th className="px-2 py-2 text-left text-[10px] font-bold text-gray-500 dark:text-gray-300 uppercase tracking-tight">SKU Original</th>
                                        ...
                                        return (
                                            ...
                                            >
                                                ...
                                                <td className="px-2 py-1.5 whitespace-nowrap">
                                                    <span className={`px-1.5 py-0.5 rounded-full text-[10px] font-black bg-blue-100 text-blue-700 dark:bg-blue-900/40 dark:text-blue-300`}>
                                                        {store}
                                                    </span>
                                                </td>
                                                <td className="px-2 py-1.5 whitespace-nowrap text-xs text-center font-black text-gray-500 dark:text-gray-300">{quantity}</td>
                                                <td className="px-2 py-1.5 whitespace-nowrap text-[10px] text-gray-400 dark:text-gray-500 font-mono italic max-w-[150px] truncate">{sku}</td>
