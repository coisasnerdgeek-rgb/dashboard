...
import { initGapi, API_KEY, CLIENT_ID, getThumbnailUrl } from '../services/googleDriveService';
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 overflow-y-auto flex-grow p-1">
                    {filteredFiles.map(file => (
                        <div key={file.id} className="border dark:border-gray-700 rounded p-2 hover:shadow-lg transition-shadow bg-gray-50 dark:bg-gray-900 relative group">
                            ...
                            >
                                {file.thumbnailLink || file.mimeType === 'application/pdf' ? (
                                    <img
                                        src={getThumbnailUrl(file as any)}
                                        alt={file.name}
                                        ...
                                        onError={(e) => {
                                            ...
                                            if (file.mimeType === 'application/pdf') {
                                                ...
                                                target.src = 'https://via.placeholder.com/150/FF0000/FFFFFF?text=Erro';
                                            }
                                        }}
                                    />
