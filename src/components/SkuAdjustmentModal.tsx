...
interface SkuAdjustmentModalProps {
    ...
    onLearnRule?: (oldSku: string, newProduct: string, newColor: string, newSize: string) => void;
...
export const SkuAdjustmentModal: React.FC<SkuAdjustmentModalProps> = ({
    ...
    const { ruleVersion } = useAppContext();
    ...
    }, [rows, skuHeader, idVendaHeader, ruleVersion]);
